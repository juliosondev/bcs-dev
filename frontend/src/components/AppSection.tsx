          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            >
              ...
              <span className="leading-tight">
                <span className="block text-[10px] text-white/60">Baixe na</span>
            ...
            >
              ...
              <span className="leading-tight">
                <span className="block text-[10px] text-white/60">Disponível no</span>
          ...
          >
            ...
            >
              ...
              <div className="mx-4 mt-5 rounded-2xl p-4" style={{ background: "linear-gradient(135deg, #d4af37, #b8860b)" }}>
                <span className="text-[10px] font-semibold text-[#0a0805]/70">CONTINUE DE ONDE PAROU</span>
                <p className="mt-1 text-sm font-bold text-[#0a0805]">Fechamento de vendas</p>
                <div className="mt-3 h-1.5 w-full rounded-full bg-black/20">
                  <div className="h-full w-2/3 rounded-full bg-[#0a0805]" />
                </div>
                <span className="mt-1.5 block text-[10px] text-[#0a0805]/70">68% concluído</span>
              </div>

              {/* Lista de trilhas */}
              <div className="mt-5 space-y-2.5 px-4">
                {["Prospecção ativa", "Negociação avançada", "Gestão de time"].map((t, i) => (
                  <div
                    key={t}
